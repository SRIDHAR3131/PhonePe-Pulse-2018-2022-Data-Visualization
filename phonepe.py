 ...
 # navigation menu
    ...
    #===================================GEO MAP TRANSACTION AMOUNT ==============================================================
        if selected=='TRANSACTION AMOUNT':
            ...
            with mode:
                ...
                fig = px.pie(pie_1, title='TYPE OF TRANSACTION',values="Transaction_amount",names="Transaction_type",hole=0.6,
            ...
            with mode1:
                ...
                val_1['Transaction_amount'] = val_1['Transaction_amount'].apply(convert_to_crore)
                st.write('') #new line
                st.write('') #new line
            ...
            with line[0]:
                ...
                fig = go.Figure(data=go.Scatter(x=line['year'], y=line['Transaction_amount'], text='Transaction_amount',mode='markers+lines',line=dict(color='orange')))
                fig.update_layout(title='YEARLY STATE TRANSACTION AMOUNT ',plot_bgcolor='mintcream')
                st.plotly_chart(fig, use_container_width=True)
    ...
    # ===================================GEO MAP TRANSACTION COUNT ==============================================================
            ...
            with mode:
                ...
                fig = px.pie(pie_1, title='TYPE OF TRANSACTION', values="Total_transaction", names="Transaction_type",
            ...
            with mode1:
                ...
                val_1['Total_transaction'] = val_1['Total_transaction'].apply(convert_to_crore1)
                st.write('')  # new line
                st.write('')  # new line
    ...
    #==================================REGISTER USER ANALYSIS==============================================================
        if selected=="REGISTER USER":
            ...
            with line[0]:
                ...
                line0['Register']=line0['Register'].apply(convert_to_lakh2)
    ...
    #===================================APP OPENED USER ANALYSIS===========================================================
            ...
            with app_trend:
                ...
                app_0['App_opened']=app_0['App_opened'].apply(convert_to_lakh2)
